  ...
  arrow: function (text) {
    ...
    return html`
      <span>
        ...
        ${words[words.length - 1]} <svg class="u-arrow" role="presentation" viewBox="0 0 7 11"><path fill="none" fill-rule="evenodd" stroke="#8D89A5" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1.66 9.9L5.9 5.66 1.66 1.4"/></svg>
      </span>
    `
  }
}
